...
(async () => {
    ...
    await page.goto("https://egzamin-informatyk.pl/jedno-pytanie-sieci-komputerowe/");
        ...
        //}await console.clear();
            ...
            var worksheet = workbook.addWorksheet('ELSK');
            //!worksheet.cell(1,1).number(102);
            for(let pastus = 0; wszystkiepytania <= 1089; pastus++){
            workbook.write('BazaPytanE.xlsx'); //tworzy/nadpisuje arkusz o tej nazwie
        ...
        }workbook.write('BazaPytanE.xlsx');
