...
(async () => {
    ...
    await page.goto("https://egzamin-informatyk.pl/jedno-pytanie-systemy-operacyjne-programy/");
        ...
        //}await console.clear();
            ...
            var worksheet = workbook.addWorksheet('SOPER');
            //!worksheet.cell(1,1).number(102);
            for(let pastus = 0; wszystkiepytania <= 488; pastus++){
            workbook.write('BazaPytanS.xlsx'); //tworzy/nadpisuje arkusz o tej nazwie
        ...
        }workbook.write('BazaPytanS.xlsx');
